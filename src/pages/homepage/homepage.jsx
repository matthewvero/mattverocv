                  ...
                  <HomepageGrid>
                        ...
                        >
                              ...
                              <SubTitle style={{ marginTop: '10px' }}>
                                    Front end developer with experience using
                                    the React ecosystem to create responsive and
                        ...
                        <InfoCard style={{ order: '2', paddingBottom: '90px' }}>
                              ...
                              <Text style={{ marginBottom: '10px' }}>
                                    ...
                                    fast-paced work and asking lots of
                                    questions.
                              </Text>
                              <Text>
                                    I have many long term goals but No.1 on my
                                    list is to become a crucial, valued member
                                    of a team doing work I genuinely believe in.
                              </Text>
                              <ButtonTouch
                                    style={{
                                          margin: '10px 0',
                        ...
                        <InfoCard style={{ order: '3', paddingBottom: '90px' }}>
                              ...
                              <HR $header />
                              <Text style={{ marginBottom: '10px' }}>
                                    I have learned everything front end using
                                    the extensive resources on the internet,
                                    including multiple Udemy Courses, YouTube,
                                    MDN etc. and fell in love with developing in
                                    the process.
                              </Text>
                              <Text>
                                    Originally I went to college to do
                                    engineering but found the pace to be too
                                    slow for me, so once I passed I started
                                    working part time and began learning to
                                    code.
                              </Text>
                              <ButtonTouch
                                    style={{
